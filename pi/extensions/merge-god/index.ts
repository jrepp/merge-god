...
export default function mergeGodPiExtension(pi: ExtensionAPI): void {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Provide grounding_refs from project docs, AGENTS.md, commandments.yaml, or Workflow-IR docs that justify the remediation scope. Use remote Workflow-IR refs only when they are pinned to immutable commit hashes.",
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "When useful, include annotations.labels with semantic PR labels from the allowed set: large, too-large, unaligned, needs-split, needs-ci, needs-rebase, needs-conflict-resolution, needs-review, needs-design, high-risk, low-risk, docs-only, test-only, embark-candidate, underlying-needed.",
