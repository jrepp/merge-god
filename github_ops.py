...
class GitHubOperations:
    ...
    def _initialize_github(self) -> None:
        ...
        try:
            ...
            raise GitHubOperationsError(f"GitHub API error: {e.data.get('message', str(e))}")
        except Exception as e:
            raise GitHubOperationsError(f"Failed to initialize GitHub: {e}")
    ...
    def get_all_prs(self, state: str = "all", limit: int = 100) -> list[PullRequest]:
        ...
        try:
            ...
            raise GitHubOperationsError(f"Failed to fetch PRs: {e.data.get('message', str(e))}")
