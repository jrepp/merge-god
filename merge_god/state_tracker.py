...
class StateTracker:
    ...
    def __init__(self, repo_path: Path | str):
        ...
        try:
            ...
            raise StateTrackerError(f"Failed to initialize operations: {e}") from e
    ...
    def fetch_and_update(self, force_fetch: bool = True) -> None:
        ...
        if force_fetch:
            try:
                ...
                raise StateTrackerError(f"Failed to fetch: {e}") from e
    ...
    def build_repository_state(
        ...
        try:
            ...
            raise StateTrackerError(f"Failed to get default branch: {e}") from e
        ...
        try:
            ...
            raise StateTrackerError(f"Failed to get branches: {e}") from e
        ...
        try:
            ...
            raise StateTrackerError(f"Failed to get PRs: {e}") from e
